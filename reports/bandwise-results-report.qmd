...
# Set p-value correction method
USE_FDR <- FALSE  # Set to FALSE for uncorrected p-values
...
- P-value correction: `r if(USE_FDR) "FDR-corrected" else "Uncorrected"`
...
- P-value correction method: `r if(USE_FDR) "FDR-corrected" else "Uncorrected"`
