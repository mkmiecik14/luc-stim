% BATCH_PREPROCESS - Batch preprocessing of EEG data for all subjects
% 
% This script processes all subjects listed in cfg.participants.ss_list
% using the preprocess_eeg() function. Reports any failed subjects at completion.

clear; clc;

fprintf('Starting batch preprocessing...\n\n');
...
for i = 1:length(subjects)
    ...
    [success, ~] = preprocess_eeg(subject_id, cfg);
